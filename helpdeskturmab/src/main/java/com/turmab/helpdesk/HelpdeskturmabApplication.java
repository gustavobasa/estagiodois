...
public class HelpdeskturmabApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
    	...
    	Tecnico tec1= new Tecnico(null, "Bill Gates", "12345678910", "bill@gmail.com", "123");
    	tec1.addPerfil(Perfil.ADMIN);

        Cliente cli1 = new Cliente(null, "Linus Torvalds", "70151804819", "linux@gmail.com", "123");
        ...
        System.out.println("✅ Mock inserido no banco com sucesso!");
    }
}
